...
class TaskSearch extends Task
{
    ...
    {
        return [
            [['id', 'created_at', 'deadline', 'importance', 'parent'], 'integer'],
            [['name', 'description', 'responsible', 'director', 'observer', 'coauthor'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'observer', $this->observer])
